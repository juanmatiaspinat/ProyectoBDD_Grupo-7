...
---------------------------------------------------
-- 1)_ Verificar que el mode de recuperación de la base de datos este en el modo adecuado para realizar backup en linea 
---------------------------------------------------
...
---------------------------------------------------
-- 2)_ Realizar un backup full de la base de datos 
---------------------------------------------------
...
/* 
Esta es la sentencia donde se ejecuta el BACKUP de la base de datos llamada base_consorcio en el archivo especificado por la variable @DireccionCarpeta correspondiente.
*/
...
Declare @DireccionCarpeta Varchar(400)
Set @DireccionCarpeta = 'F:\Backups SQL Server\Consorcio\LogBackupConsorcio ' + @Fecha + '.trn'
